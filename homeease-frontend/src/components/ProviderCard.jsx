          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <div className="flex flex-wrap gap-2 mt-1">
                {provider.reliabilityScore >= 90 && (
                  <span className="px-2 py-0.5 bg-yellow-100 text-yellow-700 text-[10px] font-black uppercase tracking-wider rounded-md border border-yellow-200 flex items-center gap-1 shadow-sm">
                    <span className="text-sm"></span> Elite Pro
                  </span>
                )}
                {provider.reliabilityScore >= 75 && provider.reliabilityScore < 90 && (
                  <span className="px-2 py-0.5 bg-blue-100 text-blue-700 text-[10px] font-black uppercase tracking-wider rounded-md border border-blue-200 flex items-center gap-1 shadow-sm">
                    <span className="text-sm">⭐</span> Top Rated in {provider.city}
                  </span>
                )}
                {provider.isVerified && (
                  <span className="px-2 py-0.5 bg-green-100 text-green-700 text-[10px] font-black uppercase tracking-wider rounded-md border border-green-200 flex items-center gap-1 shadow-sm">
