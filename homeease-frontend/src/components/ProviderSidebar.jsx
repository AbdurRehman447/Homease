...
const ProviderSidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Bookings', path: '/provider/dashboard', icon: '' },
    { name: 'My Profile', path: '/provider/profile', icon: '' },
    { name: 'Earnings', path: '/provider/earnings', icon: '' },
  ];
    ...
    <aside className="w-64 bg-gray-900 text-white min-h-screen fixed left-0 top-0">
      ...
      <div className="p-4 border-b border-gray-800">
        <div className="flex items-center space-x-3">
          <img
            src={currentUser?.image || currentUser?.avatar || 'https://i.pravatar.cc/300?img=1'}
