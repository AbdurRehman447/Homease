...
const ProviderProfileEdit = () => {
  ...
  useEffect(() => {
    if (!isAuthenticated || !currentUser) {
      ...
      // Initialize form with current provider data
      setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the update provider profile API
      ...
      <div className="flex-1 ml-64">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Manage your provider account information</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-8">
              <div className="flex items-center space-x-4">
                <img
                  src={currentUser.avatar || currentUser.image || 'https://i.pravatar.cc/150?img=2'}
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit}>
                <div className="space-y-6">
                  ...
                  {/* Bio Section */}
                  <div>
                    <h4 className="text-lg font-medium text-gray-800 mb-4">Professional Bio</h4>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        About You
                      </label>
